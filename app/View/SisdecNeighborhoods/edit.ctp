...
<?php echo $this->Form->create('SisdecNeighborhood'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sisdec Neighborhood'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SisdecNeighborhood.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SisdecNeighborhood.id'))); ?></li>
